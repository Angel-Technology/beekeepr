import type { ReactNode, FC, ComponentClass } from 'react';
...
export interface PageContentProps extends Pick<
...
export interface PaperOnboardingProps
  extends
    Pick<Partial<PaperOnboardingItemType>, 'titleStyle' | 'descriptionStyle'>,
...
export interface IndicatorsContainerProps extends PaperOnboardingIndicatorConfig {
  animatedIndex: SharedValue<number>;
  data: PaperOnboardingItemType[];
  animatedIndicatorsContainerPosition: SharedValue<number>;
  safeInsets: Required<Insets>;
}
...
export interface BackgroundProps extends Pick<
  PaperOnboardingIndicatorConfig,
  'indicatorSize'
> {
  data: Array<PaperOnboardingItemType>;
  animatedIndex: SharedValue<number>;
...
export interface BackgroundCircleProps extends Pick<
  PaperOnboardingIndicatorConfig,
  'indicatorSize'
> {
  index: number;
