...
export type AuthUserFieldsFragment = { __typename?: 'UserGraph', id: string, email: string, displayName?: string | null, emailVerified: boolean, createdAtUtc: string, identityVerificationStatus: IdentityVerificationStatus, personaInquiryId?: string | null, personaInquiryStatus?: PersonaInquiryStatus | null, termsAcceptedAtUtc?: string | null };

export type AcceptTermsMutationVariables = Exact<{ [key: string]: never; }>;


export type AcceptTermsMutation = { __typename?: 'UserMutations', acceptTerms: { __typename?: 'AcceptTermsPayload', error?: string | null, user?: { __typename?: 'UserGraph', id: string, email: string, displayName?: string | null, emailVerified: boolean, createdAtUtc: string, identityVerificationStatus: IdentityVerificationStatus, personaInquiryId?: string | null, personaInquiryStatus?: PersonaInquiryStatus | null, termsAcceptedAtUtc?: string | null } | null } };
...
export type SignInWithGoogleMutation = { __typename?: 'UserMutations', signInWithGoogle: { __typename?: 'SignInWithGooglePayload', error?: string | null, session?: { __typename?: 'AuthSessionGraph', token: string, expiresAtUtc: string } | null, user?: { __typename?: 'UserGraph', id: string, email: string, displayName?: string | null, emailVerified: boolean, createdAtUtc: string, identityVerificationStatus: IdentityVerificationStatus, personaInquiryId?: string | null, personaInquiryStatus?: PersonaInquiryStatus | null, termsAcceptedAtUtc?: string | null } | null } };
...
export type CurrentUserQuery = { __typename?: 'UserQueries', currentUser?: { __typename?: 'UserGraph', id: string, email: string, displayName?: string | null, emailVerified: boolean, createdAtUtc: string, identityVerificationStatus: IdentityVerificationStatus, personaInquiryId?: string | null, personaInquiryStatus?: PersonaInquiryStatus | null, termsAcceptedAtUtc?: string | null } | null };
