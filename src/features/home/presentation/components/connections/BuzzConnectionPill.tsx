      ...
      <View className="relative flex-row items-center">
        {tabWidth > 0 ? (
          <Animated.View
            ...
            className="border-tk-border-secondary bg-tk-bg-primary rounded-round border shadow-small"
          />
        ) : null}
          ...
          return (
            ...
            >
              ...
              <View className="relative">
                ...
                {showBadge ? (
                  <View className="bg-tk-alerts-danger absolute -right-5 -top-1.5 items-center justify-center rounded-full px-1">
